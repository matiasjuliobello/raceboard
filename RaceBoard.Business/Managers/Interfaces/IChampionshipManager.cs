...
namespace RaceBoard.Business.Managers.Interfaces
{
    public interface IChampionshipManager
    {
        ...
        PaginatedResult<ChampionshipBoatReturn> GetCommitteeBoatReturns(ChampionshipBoatReturnSearchFilter? searchFilter = null, PaginationFilter? paginationFilter = null, Sorting? sorting = null, ITransactionalContext? context = null);
        void CreateCommitteeBoatReturn(ChampionshipBoatReturn committeeBoatReturn, ITransactionalContext? context = null);
