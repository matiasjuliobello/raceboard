...
namespace RaceBoard.IoC
{
    public static class IoC
    {
        public static void ConfigureIoC(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IChampionshipCommitteeBoatReturnManager, ChampionshipCommitteeBoatReturnManager>();
            ...
            services.AddTransient<ICustomValidator<ChampionshipCommitteeBoatReturn>, ChampionshipCommitteeBoatReturnValidator>();
